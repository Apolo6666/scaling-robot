diff --git a/medic_assistant.py b/medic_assistant.py
index 49970770cd20a92d82d54992eabf1feb3fceb7f5..1aa737555f745db0ca5d5019715f94514adc6979 100644
--- a/medic_assistant.py
+++ b/medic_assistant.py
@@ -1,173 +1,484 @@
 """
...
@@ -192,293 +503,433 @@ async def set_level(update: Update, context: ContextTypes.DEFAULT_TYPE):
